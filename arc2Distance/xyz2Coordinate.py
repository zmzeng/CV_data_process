...
class xyz2Coordinate(object):
    ...
    def plotData(self):
        ...
        plt.plot(self.listOfTime, self.listOfatom[0], label='x')
        plt.plot(self.listOfTime, self.listOfatom[1], label='y')
        plt.plot(self.listOfTime, self.listOfatom[2], label='z')
        plt.legend()
        plt.xlabel('Tims (ps)')
